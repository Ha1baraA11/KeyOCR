...
- CI 显式安装 paddleocr 全部传递依赖（pandas、scipy、shapely、pyclipper、requests 等）+ `paddlex[ocr]`
- `build.bat` 本地打包也安装 `paddlex[ocr]`
- spec 的 hidden_imports 包含 paddlex[ocr] 核心传递依赖（aistudio_sdk、modelscope、huggingface_hub 等）
